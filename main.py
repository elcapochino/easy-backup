...
button_rem = tk.Button(frame_backups, text='- Remove Backup Definition', command=None, width=22, height=1, pady=5)
...
button_rem = tk.Button(frame_details_source, text='- Remove Folder/File', command=None, width=18, height=1, pady=5)
...
tk.Button(frame_details_destination, text='Change', command=None).grid(row=0, column=1)
tk.Button(frame_details_destination, text='Open', command=None).grid(row=0, column=2)
