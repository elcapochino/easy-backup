...
# with open(r'testfolder\test_dump.txt', 'w', encoding='utf-8') as f:
#     data = [{'ID': 0, 'name': 'Mein erstes Bäckup', 'sources': ['D:\\Schule\\Komplexe Leistung\\Berechnung von Pi anhand von kollidierenden Körpern\\Python\\Kollisions-Simulator 2000', 'C:\\flutter\\.pub-cache', 'D:\\Downloads\\Towny-master'], 'destination': 'D:\\Backups', 'intervals': {'full': '1w', 'differential': '1d'}}, {'ID': 1, 'name': 'Eine weitere Sicherung', 'from': ['D:\\Autos\\Porsche\\Fensterlose Modelle', 'D:\\Schule\\Hausaufgaben', 'C:\\Meine Bilder\\Urlaub 2019'], 'to': 'D:\\Backups\\2', 'intervals': {'full': '3d'}}]
